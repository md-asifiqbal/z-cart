...
class Cancellation extends BaseModel
{
    ...
    */
    ...
    public function approve()
    {
        ...
        // Cancel the order if the cancellation is for all items
        if($this->isPartial()) {
            event(new OrderCancellationRequestApproved($this->order));
        }
        else{
            $this->order->cancel();
        }
    ...
    {
        $this->forceFill(['status' => static::STATUS_OPEN])->save();
    }
    /**
