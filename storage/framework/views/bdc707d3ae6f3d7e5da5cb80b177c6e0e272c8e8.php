<div class="modal-dialog modal-lg">
    <div class="modal-content">
    	<?php echo Form::open(['route' => 'admin.appearance.slider.store', 'files' => true, 'id' => 'form', 'data-toggle' => 'validator']); ?>
...
</div> <!-- / .modal-dialog --><?php /**PATH /home/amraibes/public_html/resources/views/admin/slider/_create.blade.php ENDPATH**/ ?>