    ...
    $(document).ready(function()
    {
	    ...
	    function setShippingZone(cart, country_id, state_id)
	    {
            ...
            if($.isEmptyObject(zone)){
                <?php echo $__env->make('layouts.notification', ['message' => trans('theme.notify.seller_doesnt_ship'), 'type' => 'warning', 'icon' => 'times-circle'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            }
    	...
    	$('.cart-item-remove').on('click', function(e){
			...
			$.ajax({
			    ...
			    complete: function (xhr, textStatus) {
			    	if(200 == xhr.status){
		                <?php echo $__env->make('layouts.notification', ['message' => trans('theme.notify.item_removed_from_cart'), 'type' => 'success', 'icon' => 'check-circle'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	        ...
	        if(coupon){
				...
				.fail(function(response) {
			        if (401 === response.status){
	                    ...
	                    <?php echo $__env->make('layouts.notification', ['message' => trans('theme.notify.coupon_not_valid'), 'type' => 'warning', 'icon' => 'times-circle'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
			        }
			        else if (404 === response.status){
	                    <?php echo $__env->make('layouts.notification', ['message' => trans('theme.notify.coupon_not_exist'), 'type' => 'danger', 'icon' => 'times-circle'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
			        }
			        else if (443 === response.status){
	                    <?php echo $__env->make('layouts.notification', ['message' => trans('theme.notify.coupon_not_valid_for_zone'), 'type' => 'warning', 'icon' => 'times-circle'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
			        }
			        else if (444 === response.status){
	                    <?php echo $__env->make('layouts.notification', ['message' => trans('theme.notify.coupon_limit_expired'), 'type' => 'warning', 'icon' => 'times-circle'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
			        }
			        else{
	                    <?php echo $__env->make('layouts.notification', ['message' => trans('theme.notify.failed'), 'type' => 'danger', 'icon' => 'times-circle'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
			        }
		...
		function setShippingOptions(cart)
		{
			...
			if( ! $.isEmptyObject(filtered) ){
				...
				if(isFreeShipping(cart)) {
		            setShippingCost(cart, '<?php echo e(trans('theme.free_shipping'), false); ?>', 0, 0);
				}
				else {
		...
		{
			if(coupon == null){
                <?php echo $__env->make('layouts.notification', ['message' => trans('theme.notify.coupon_not_valid'), 'type' => 'danger', 'icon' => 'times-circle'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				resetDiscount(cart);
				return;
			}
			...
			if(coupon.min_order_amount && totalPrice < coupon.min_order_amount){
                <?php echo $__env->make('layouts.notification', ['message' => trans('theme.notify.coupon_min_order_value'), 'type' => 'danger', 'icon' => 'times-circle'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				resetDiscount(cart);
				return;
			}
			...
			<?php echo $__env->make('layouts.notification', ['message' => trans('theme.notify.coupon_applied'), 'type' => 'success', 'icon' => 'check-circle'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</script><?php /**PATH /home/amraibest.com/public_html/public/themes/default/views/scripts/dynamic_checkout.blade.php ENDPATH**/ ?>