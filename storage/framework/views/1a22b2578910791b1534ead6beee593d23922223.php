	...
	<div class="box">
	    <div class="box-header with-border">
	      ...
	      <div class="box-tools pull-right">
			<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\CategoryGroup::class)): ?>
	    ...
	    <div class="box-body">
	      <table class="table table-hover table-2nd-no-sort">
	        <thead>
	        <tr>
				<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('massDelete', App\CategoryGroup::class)): ?>
	        ...
	        <tbody id="massSelectArea">
		        <?php $__currentLoopData = $categoryGrps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryGrp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			        <tr>
					  ...
					  <?php endif; ?>
			          <td>
			          	<?php if(Storage::exists(optional($categoryGrp->images->first())->path)): ?>
							<img src="<?php echo e(get_storage_file_url(optional($categoryGrp->images->first())->path, 'small'), false); ?>" class="" alt="<?php echo e(trans('app.background_image'), false); ?>">
  						<?php endif; ?>
			          </td>
			          <td>
			          	<?php if(Storage::exists(optional($categoryGrp->featuredImage)->path)): ?>
							<img src="<?php echo e(get_storage_file_url(optional($categoryGrp->featuredImage)->path, 'cover_thumb'), false); ?>" class="img-sm" alt="<?php echo e(trans('app.cover_image'), false); ?>">
  						<?php endif; ?>
			          </td>
			          <td>
			          	<h5>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amraibes/public_html/resources/views/admin/category/categoryGroup.blade.php ENDPATH**/ ?>