...
;(function($, window, document) {
    var free_shipping = '<?php echo e($item->free_shipping, false); ?>';
    var shop_id = '<?php echo e($item->shop_id, false); ?>';
    var handlingCost = getFromPHPHelper('getShopConfig', [shop_id, 'order_handling_cost']);
    var unitPrice = <?php echo e($item->currnt_sale_price(), false); ?>;
        ...
        $('.dynamic-shipping-rates').popover({
            ...
            content: function(){
                ...
                if($.isEmptyObject(filtered)){
                    ...
                    if(free_shipping){
                        options += "<tr><td><div class='radio'><label id='0' data-option='" + JSON.stringify({name: '<?php echo e(trans('theme.free_shipping'), false); ?>', rate: 0}) + "'><input type='radio' name='shipping_option' id='<?php echo e(trans('theme.free_shipping'), false); ?>' value='"+ getFormatedValue(0) +"' "+ preChecked +"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans('theme.free_shipping'), false); ?></label></div></td>" +
                        '<td>&nbsp;</td>' +
...
// END NEW CODE //////////////////////////
    ...
    {
        var unit_weight = '<?php echo e($item->shipping_weight, false); ?>';
        var qtt = $('input.product-info-qty-input').val();
    ...
    function setShippingCost(shipping)
    {
        ...
        if (free_shipping == 1 && shipping.rate == 0) {
            ...
            $('#summary-shipping-cost').attr('data-value', 0).html( getFormatedPrice(value) );
            ...
            var delivery_takes = shipping.delivery_takes ? '<?php echo e(trans('theme.estimated_delivery_time'), false); ?>: ' + shipping.delivery_takes : '';
    ...
    function setShippingOptions()
    {
        $.when(
            ...
            if(filtered.length){
                if (free_shipping == 1) {
                    setShippingCost({name: '<?php echo e(trans('theme.free_shipping'), false); ?>', rate: 0});       // Set free shipping
                }
                else {
...
</script><?php /**PATH /home/amraibest.com/public_html/public/themes/default/views/scripts/product_page.blade.php ENDPATH**/ ?>