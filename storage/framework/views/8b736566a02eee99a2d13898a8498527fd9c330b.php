	...
	<div class="box">
		<div class="box-header with-border">
			...
			<div class="box-tools pull-right">
				<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Coupon::class)): ?>
		...
		<div class="box-body">
			<table class="table table-hover table-no-sort">
				<thead>
					<tr>
						<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('massDelete', App\Coupon::class)): ?>
		        ...
		        <tbody id="massSelectArea">
					...
					<tr>
						...
						<td class="row-options">
							<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view', $coupon)): ?>
							...
							<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $coupon)): ?>
			...
			<table class="table table-hover table-no-sort">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<?php echo e($trash->type == 'amount' ? get_formated_currency($trash->value, true, 2) : get_formated_decimal($trash->value) . ' ' . trans('app.percent'), false); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amraibes/public_html/resources/views/admin/coupon/index.blade.php ENDPATH**/ ?>