<div id="zcart_chat">
  	<div id="chat-window" class="chat">
	    ...
	    <div id="chat_conversation" class="chat_converse">
	        {{-- <a id="chat_second_screen" class="fchat"><i class="fa fa-arrow-right"></i></a> --}}
        ...
        @if(Auth::guard('customer')->check())
		    <div class="fchat_field">
		      {{-- <a id="fchat_camera" class="fchat"><i class="fa fa-camera"></i></a> --}}
		      <a id="fchat_send" class="fchat"><i class="fa fa-paper-plane"></i></a>
	...
	<a id="chatbox" class="fchat">
		<i class="chat-icon fa fa-comment"></i>
	</a>
</div>
