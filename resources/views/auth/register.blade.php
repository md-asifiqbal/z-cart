  ...
  <div class="box login-box-body">
    ...
    <div class="box-body">
      ...
      {!! Form::open(['route' => 'register', 'id' => config('system_settings.required_card_upfront') ? 'stripe-form' : 'registration-form', 'data-toggle' => 'validator']) !!}
        ...
        <div class="form-group has-feedback">
          {!! Form::text('email', null, ['class' => 'form-control input-lg', 'placeholder' =>'Email or Mobile No', 'required','type'=>'text','id'=>'mobile']) !!}
       ...
       <button id="regenerateOTP" class="btn btn-danger btn_shadow" style="border-radius: 0;" onclick="sendOtp()" >Resend OTP <span id="timer"></span></button> 
        ...
        <div class="row">
          ...
          <div class="col-xs-4">
            <input class="btn btn-block btn-lg flat btn-primary sent-otp" onclick="sendOtp()" type="button" value="{{ trans('app.form.register') }}" />
            {!! Form::submit('Verify Account', ['id' => 'card-button', 'class' => 'btn btn-block btn-lg btn-flat btn-primary otp']) !!}
          </div>
        </div>
      {!! Form::close() !!}
