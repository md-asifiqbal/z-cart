  ...
  <div class="box login-box-body">
    ...
    <div class="box-body">
        ...
        <div class="form-group has-feedback">
          {!! Form::text('email', null, ['class' => 'form-control input-lg', 'placeholder' => 'Email or Mobile No', 'required', 'id'=>"forgotmobile"]) !!}
          <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          <div class="help-block with-errors" id="forgotmobileError"></div>
        </div>

        {!! Form::submit('Send OTP', ['class' => 'btn btn-block btn-lg btn-flat btn-primary','onclick'=>"forgotPassword()"]) !!}
