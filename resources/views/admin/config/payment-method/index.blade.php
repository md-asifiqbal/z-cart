...
<p class="list-group-item-text">
   ...
   @if($payment_provider->code == 'bkash')
  ...
  <form class="form-inline" action="{{route('admin.account.bkash.update')}}" method="post">
     {!! csrf_field() !!}
  <div class="form-group">
    <label for="bkash">Bkash No:</label>
    <input type="number" class="form-control" id="bkash" name="bkash" value="{{$bkash}}" required>
  </div>
...
@elseif($payment_provider->code == 'bkash')
