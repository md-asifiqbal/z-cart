...
class CreditApi
{
     ...
     * Process a Credit
     *
     * @param \Incevio\Cybersource\CybersourceSDK\Model\CreateCreditRequest $createCreditRequest  (required)
     * @throws \Incevio\Cybersource\CybersourceSDK\ApiException on non-2xx response
     * @return array of \Incevio\Cybersource\CybersourceSDK\Model\PtsV2CreditsPost201Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function createCreditWithHttpInfo($createCreditRequest)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Incevio\Cybersource\CybersourceSDK\Model\PtsV2CreditsPost201Response',
                '/pts/v2/credits'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Incevio\Cybersource\CybersourceSDK\Model\PtsV2CreditsPost201Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Incevio\Cybersource\CybersourceSDK\Model\PtsV2CreditsPost201Response', $e->getResponseHeaders());
