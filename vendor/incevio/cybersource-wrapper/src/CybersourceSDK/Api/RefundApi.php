...
class RefundApi
{
     ...
     * Refund a Capture
     *
     * @param \Incevio\Cybersource\CybersourceSDK\Model\RefundCaptureRequest $refundCaptureRequest  (required)
     ...
     * @return array of \Incevio\Cybersource\CybersourceSDK\Model\PtsV2PaymentsRefundPost201Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function refundCaptureWithHttpInfo($refundCaptureRequest, $id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Incevio\Cybersource\CybersourceSDK\Model\PtsV2PaymentsRefundPost201Response',
                '/pts/v2/captures/{id}/refunds'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Incevio\Cybersource\CybersourceSDK\Model\PtsV2PaymentsRefundPost201Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Incevio\Cybersource\CybersourceSDK\Model\PtsV2PaymentsRefundPost201Response', $e->getResponseHeaders());
     ...
     * Refund a Payment
     *
     * @param \Incevio\Cybersource\CybersourceSDK\Model\RefundPaymentRequest $refundPaymentRequest  (required)
