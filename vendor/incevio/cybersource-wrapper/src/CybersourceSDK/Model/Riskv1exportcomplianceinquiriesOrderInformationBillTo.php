...
class Riskv1exportcomplianceinquiriesOrderInformationBillTo implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'locality' => 'string',
        'postalCode' => 'string',
        'company' => '\Incevio\Cybersource\CybersourceSDK\Model\Riskv1exportcomplianceinquiriesOrderInformationBillToCompany',
        'firstName' => 'string',
        'lastName' => 'string',
        'email' => 'string'
    ];
     ...
     * @param string $administrativeArea State or province of the billing address. Use the State, Province, and Territory Codes for the United States and Canada.  For Payouts: This field may be sent only for FDC Compass.  ##### Incevio\Cybersource\CybersourceSDK through VisaNet Credit card networks cannot process transactions that contain non-ASCII characters. Incevio\Cybersource\CybersourceSDK through VisaNet accepts and stores non-ASCII characters correctly and displays them correctly in reports. However, the limitations of the credit card networks prevent Incevio\Cybersource\CybersourceSDK through VisaNet from transmitting non-ASCII characters to the credit card networks. Therefore, Incevio\Cybersource\CybersourceSDK through VisaNet replaces non-ASCII characters with meaningless ASCII characters for transmission to the credit card networks.  **Important** It is your responsibility to determine whether a field is required for the transaction you are requesting.  For processor-specific information, see the `bill_state` field description in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html)
     * @return $this
     */
    ...
    /**
     * Gets company
     * @return \Incevio\Cybersource\CybersourceSDK\Model\Riskv1exportcomplianceinquiriesOrderInformationBillToCompany
     */
    ...
    /**
     * Sets company
     * @param \Incevio\Cybersource\CybersourceSDK\Model\Riskv1exportcomplianceinquiriesOrderInformationBillToCompany $company
     * @return $this
     */
