...
class TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseEmbeddedMerchantInformationMerchantDescriptor implements ArrayAccess
{
    ...
    /**
     * Sets alternateName
     * @param string $alternateName Alternate information for your business. This API field overrides the company entry description value in your Incevio\Cybersource\CybersourceSDK account.
     * @return $this
     */
