...
class TssV2TransactionsGet200ResponseClientReferenceInformation implements ArrayAccess
{
    ...
    /**
     * Sets code
     * @param string $code Client-generated order reference or tracking number. Incevio\Cybersource\CybersourceSDK recommends that you send a unique value for each transaction so that you can perform meaningful searches for the transaction.  For information about tracking orders, see \"Tracking and Reconciling Your Orders\" in [Getting Started with Incevio\Cybersource\CybersourceSDK Advanced for the SCMP API.](https://apps.cybersource.com/library/documentation/dev_guides/Getting_Started_SCMP/html/)  #### FDC Nashville Global Certain circumstances can cause the processor to truncate this value to 15 or 17 characters for Level II and Level III processing, which can cause a discrepancy between the value you submit and the value included in some processor reports.
     * @return $this
     */
     ...
     * @param string $applicationVersion Version of the Incevio\Cybersource\CybersourceSDK application or integration used for a transaction.
     * @return $this
     */
     ...
     * @param string $applicationName The name of the Connection Method client (such as Virtual Terminal or SOAP Toolkit API) that the merchant uses to send a transaction request to Incevio\Cybersource\CybersourceSDK.
     * @return $this
     */
     ...
     * @param string $applicationUser The entity that is responsible for running the transaction and submitting the processing request to Incevio\Cybersource\CybersourceSDK. This could be a person, a system, or a connection method.
     * @return $this
     */
