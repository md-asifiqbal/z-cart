...
class Ptsv2paymentsClientReferenceInformationPartner implements ArrayAccess
{
    ...
    /**
     * Sets developerId
     * @param string $developerId Identifier for the developer that helped integrate a partner solution to Incevio\Cybersource\CybersourceSDK.  Send this value in all requests that are sent through the partner solutions built by that developer. Incevio\Cybersource\CybersourceSDK assigns the ID to the developer.  **Note** When you see a developer ID of 999 in reports, the developer ID that was submitted is incorrect.
     * @return $this
     */
    ...
    /**
     * Sets solutionId
     * @param string $solutionId Identifier for the partner that is integrated to Incevio\Cybersource\CybersourceSDK.  Send this value in all requests that are sent through the partner solution. Incevio\Cybersource\CybersourceSDK assigns the ID to the partner.  **Note** When you see a partner ID of 999 in reports, the partner ID that was submitted is incorrect.
     * @return $this
     */
     ...
     * @param string $thirdPartyCertificationNumber Value that identifies the application vendor and application version for a third party gateway. Incevio\Cybersource\CybersourceSDK provides you with this value during testing and validation. This field is supported only on Incevio\Cybersource\CybersourceSDK through VisaNet.
     * @return $this
     */
