...
class Ptsv2paymentsOrderInformationInvoiceDetails implements ArrayAccess
{
     ...
     * @param string $referenceDataNumber Reference number. The meaning of this value is identified by the value of the `referenceDataCode` field.  This field is a pass-through, which means that Incevio\Cybersource\CybersourceSDK does not verify the value or modify it in any way before sending it to the processor.
     * @return $this
     */
     ...
     * @param int $salesSlipNumber Transaction identifier that Incevio\Cybersource\CybersourceSDK generates. You have the option of printing the sales slip number on the receipt. This field is supported only on Cybersource through Visanet and JCN gateway.
     * @return $this
     */
