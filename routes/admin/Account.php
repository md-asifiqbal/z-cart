<?php
    ...
    Route::post('ticket/{ticket}/storeReply', 'AccountController@storeTicketReply')->name('ticket.storeReply');
   	...
   	Route::post('billing-sum', 'AccountController@billing_sum')->name('billing.sum');
  Route::post('billing-update', 'AccountController@UpdateBilling')->name('billing.update');
  
Route::post('bkash-no-update', 'AccountController@bkashUpdate')->name('bkash.update');
